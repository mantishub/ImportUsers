...
# --------------------
function csv_user_create( $p_username, $p_password, $p_email = '',$p_access_level = null, $p_protected = false, $p_enabled = true,$p_realname = '', $f_invite_emails = false, $p_admin_name = '' ) {
